...
description: "Use this skill when writing, editing, fixing, or reviewing package tests with Pest 5 and Orchestra Testbench 11, including TDD, feature tests, unit tests, type coverage, arch tests, workbench behavior, commands, routes, config, migrations, and publishable resources."
license: MIT
metadata:
  author: laravel
---
...
Prove package behavior with Pest 5, Orchestra Testbench 11, and the local `tests/TestCase.php` setup before or alongside implementation.
